              ...
              <div className={s.targetValueInputsContainer}>
                ...
                >
                  ...
                  <Select
                    ...
                    onChange={(e) => onElementCountMethodChange(e.target.value)}
                  ...
                  >
                    ...
                    {/* <MenuItem disabled={selectedTargetValue.valueFormat === 'string' || selectedTargetValue.valueFormat === 'percentile'} className="dropdown-option" value={'summForTime'}>Sum of Values For The Last N Days</MenuItem> */}
                  </Select>
                </FormControl>
        ...
        {targetEvent !== undefined &&
          ...
          targetEvent.values.length > 0 && (
            <div className={s.conditionsBody}>
              <div className={s.conditionsHeader}>
                ...
                <Tooltip
                  ...
                  title={`Value filters are used to filter events by their custom
                      ...
                      certain value in certain field. If you want to filter by a
                      specific category (e.g. "Country" or "Game Version"), you
                      should use "Category filters" instead.`}
                  placement="top"
                >
                  <IconButton
              ...
              <Box sx={{ p: 1, border: "1px solid #40367D" }}>
                    ...
                    <div className={s.valueContainer} key={index}>
                      ...
                      >
                        ...
                        >
                          ...
                          {getValueFormatByConditionIndex(index) === "bool" && [
                            <MenuItem
                              className="dropdown-option"
                              key="is"
                              value={"is"}
        ...
        {targetEvent !== undefined &&
          ...
          targetEvent.values.length > 0 && (
            <div className={s.conditionsBody}>
              ...
              <Box sx={{ p: 1, border: "1px solid #40367D" }}>
                {analyticsQuery.queryCategoryFilters.map((condition, index) => (
                  <Box sx={{ p: 0 }}>
                    <div className={s.valueContainer} key={index}>
                      <FormControl size="small" sx={{ m: 1, width: "70%" }}>
                        <InputLabel id="demo-simple-select-small-label">
                      ...
                      {analyticsQuery.queryCategoryFilters[index]?.condition ===
                        "range" && <div>-</div>}
                      {analyticsQuery.queryCategoryFilters[index]?.condition ===
                        "range" && (
                        <FormControl
                        ...
                        >
                          <OutlinedInput
                            ...
                            onChange={(e) =>
                              onChangeCategoryFilter_SetSecondaryValue(e, index)
                            }
                            endAdornment={
                              <InputAdornment position="end">
                                {(() => {
